...
call('apt-get -qy install oracle-java7-installer')

append('/etc/environment', 'JAVA_HOME="/usr/lib/jvm/java-7-oracle"\n')
append('/etc/environment', 'JRE_HOME="/usr/lib/jvm/java-7-oracle/jre"\n')
append('/etc/environment', 'JDK_HOME="/usr/lib/jvm/java-7-oracle/"\n')
